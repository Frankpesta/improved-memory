	...
	return (
		<div className="container mx-auto bg-gradient-to-b from-primary-50 to-white dark:from-primary-950/50 dark:to-background">
			<PageHeader
				...
				description="At Credix AI, our AI-powered trading technology delivers consistent returns by leveraging the best market opportunities. Our diversified portfolio ensures stable and profitable trading cycles, making us a trusted choice for over 250,000+ users worldwide. Below is an overview of our trading portfolio, including our AI trading strategies, capital allocations, and historical performance."
				align="center"
			/>
			<PortfolioPage />
			<TowerResearchCard />
